...
In the MA plot above, all inter-chromosomal interactions lie within the main bulk of M-values at $\sim$2 whereas only intra-chromosomal interactions make up the cloud at $\sim$7.
This is consistent with the specificity of the latter.
